...
<head>
    ...
    <meta content="Study Abroad, Educational Consultancy, Travel Services, Student Visa, Cultural Exchange" name="keywords">
    <meta content="Study Barn Travels specializes in educational consultancy and travel planning services. We create opportunities for academic growth and cultural experiences worldwide." name="description">
                ...
                <div class="row g-5">
                    <div class="col-xl-5 wow fadeInLeft" data-wow-delay="0.1s">
                        <div class="bg-light rounded">
                            <img src="img/about-2.png" class="img-fluid w-100" style="margin-bottom: -7px;" alt="Study Barn Travels Image">
                            <img src="img/about-3.jpg" class="img-fluid w-100 border-bottom border-5 border-primary" style="border-top-right-radius: 300px; border-top-left-radius: 300px;" alt="Study Barn Travels Cultural Experience">
                        </div>
                    </div>
                    <div class="col-xl-7 wow fadeInRight" data-wow-delay="0.3s">
                        <h5 class="sub-title pe-3">About Study Barn Travels</h5>
                        <h1 class="display-5 mb-4">Empowering Dreams Through Education & Travel</h1>
                        <p class="mb-4">At Study Barn Travels, we specialize in creating unparalleled opportunities for growth by combining academic excellence with rich cultural experiences. Whether you’re pursuing international education, training, or global exploration, we’re here to guide you every step of the way.</p>
                        <div class="row gy-4 align-items-center">
                            <div class="col-12 col-sm-6 d-flex align-items-center">
                                <i class="fas fa-graduation-cap fa-3x text-secondary"></i>
                                <h5 class="ms-4">Expert Education Consultancy</h5>
                            </div>
                            <div class="col-12 col-sm-6 d-flex align-items-center">
                                <i class="fas fa-plane-departure fa-3x text-secondary"></i>
                                <h5 class="ms-4">Tailored Travel Solutions</h5>
                            </div>
                            ...
                            <div class="col-8 col-md-9">
                                <div class="mb-5">
                                    <p class="text-primary h6 mb-3"><i class="fa fa-check-circle text-secondary me-2"></i> Genuine & Reliable Guidance</p>
                                    <p class="text-primary h6 mb-3"><i class="fa fa-check-circle text-secondary me-2"></i> Fast & Hassle-Free Processes</p>
                                    <p class="text-primary h6 mb-3"><i class="fa fa-check-circle text-secondary me-2"></i> Expert Academic & Travel Advice</p>
                                </div>
...
<div class="container-fluid training overflow-hidden bg-light py-5">
    <div class="container py-5">
        <div class="section-title text-center mb-5 wow fadeInUp" data-wow-delay="0.1s">
            ...
            <h1 class="display-5 mb-4">Get the Best Test Preparation with Study Barn</h1>
            <p class="mb-0">We provide professional coaching and guidance to help you succeed in international exams required for study abroad opportunities.</p>
        </div>
        <div class="row g-4">
            <div class="col-lg-6 col-xl-3 wow fadeInUp" data-wow-delay="0.1s">
                <div class="training-item">
                    <div class="training-inner">
                        <img src="img/training-1.jpg" class="img-fluid w-100 rounded" alt="IELTS">
                        <div class="training-title-name">
                            <a href="#" class="h4 text-white mb-0">IELTS Coaching</a>
                        </div>
                    </div>
                    <div class="training-content bg-secondary rounded-bottom p-4">
                        <h4 class="text-white">IELTS Coaching</h4>
                        <p class="text-white-50">Achieve the scores you need for study and migration with our expert IELTS training.</p>
            ...
            <div class="col-lg-6 col-xl-3 wow fadeInUp" data-wow-delay="0.3s">
                <div class="training-item">
                    <div class="training-inner">
                        <img src="img/training-2.jpg" class="img-fluid w-100 rounded" alt="TOEFL">
                        <div class="training-title-name">
                            <a href="#" class="h4 text-white mb-0">TOEFL Coaching</a>
                        </div>
                    </div>
                    <div class="training-content bg-secondary rounded-bottom p-4">
                        <h4 class="text-white">TOEFL Coaching</h4>
                        <p class="text-white-50">Get personalized strategies to excel in TOEFL and secure your academic future.</p>
                        <a class="btn btn-secondary rounded-pill text-white p-0" href="#">Read More <i class="fa fa-arrow-right"></i></a>
                    </div>
                </div>
            </div>
            <div class="col-lg-6 col-xl-3 wow fadeInUp" data-wow-delay="0.5s">
                <div class="training-item">
                    <div class="training-inner">
                        <img src="img/training-3.jpg" class="img-fluid w-100 rounded" alt="PTE">
                        <div class="training-title-name">
                            <a href="#" class="h4 text-white mb-0">PTE Coaching</a>
                        </div>
                    </div>
                    <div class="training-content bg-secondary rounded-bottom p-4">
                        <h4 class="text-white">PTE Coaching</h4>
                        <p class="text-white-50">Master the PTE exam with practical exercises and proven strategies.</p>
                        <a class="btn btn-secondary rounded-pill text-white p-0" href="#">Read More <i class="fa fa-arrow-right"></i></a>
                    </div>
                </div>
            </div>
            <div class="col-lg-6 col-xl-3 wow fadeInUp" data-wow-delay="0.7s">
                <div class="training-item">
                    <div class="training-inner">
                        <img src="img/training-4.jpg" class="img-fluid w-100 rounded" alt="OET">
                        <div class="training-title-name">
                            <a href="#" class="h4 text-white mb-0">OET Coaching</a>
                        </div>
                    </div>
                    <div class="training-content bg-secondary rounded-bottom p-4">
                        <h4 class="text-white">OET Coaching</h4>
                        <p class="text-white-50">Specialized coaching for healthcare professionals preparing for OET.</p>
                        <a class="btn btn-secondary rounded-pill text-white p-0" href="#">Read More <i class="fa fa-arrow-right"></i></a>
                    </div>
                </div>
            </div>
        ...
        <div class="row g-5">
            ...
            <div class="col-md-6 col-lg-6 col-xl-3">
                <div class="footer-item d-flex flex-column">
                    ...
                    <a href="#"><i class="fas fa-angle-right me-2"></i> Study Abroad Consultancy</a>
                    <a href="#"><i class="fas fa-angle-right me-2"></i> Visa Guidance</a>
                    <a href="#"><i class="fas fa-angle-right me-2"></i> Travel Planning</a>
                    <a href="#"><i class="fas fa-angle-right me-2"></i> Test Preparation</a>
            ...
            <div class="col-md-6 col-lg-6 col-xl-3">
                <div class="footer-item">
                    ...
                    <p class="text-white mb-3">Stay updated with the latest study abroad opportunities, scholarships, and travel tips from Study Barn Travels.</p>
